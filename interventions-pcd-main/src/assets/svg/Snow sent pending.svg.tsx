...
export type SnowSentPendingIconProps = SVGProps<SVGSVGElement> & {
  title?: string;
};

const SnowSentPendingIcon = forwardRef<SVGSVGElement, SnowSentPendingIconProps>(
  ({ title, ...props }, ref) => (
    <svg width="256" height="256" viewBox="0 0 256 256" fill="none"
      ...
      <g stroke="#8a5a00" strokeWidth="25" strokeLinecap="round"
        ...
        <path d="M62 211H194" /><path d="M164 181L194 211L164 241" />
      </g>
...
SnowSentPendingIcon.displayName = "SnowSentPendingIcon";
export { SnowSentPendingIcon as ReactComponent };
export default SnowSentPendingIcon;
