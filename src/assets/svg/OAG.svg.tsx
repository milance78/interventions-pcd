...
export const ReactComponent = (
  ...
  >
    ...
    <g filter="url(#oagIconShadow)">
      <circle cx="32" cy="32" r="25.5" fill="url(#oagIconEdge)" />
      <circle cx="32" cy="30.5" r="24" fill="url(#oagIconFace)" />
      <path d="M14 27C17 16 24 10 32 10C41 10 48 16 51 26C42 21 23 21 14 27Z" fill="url(#oagIconGloss)" />
      <circle cx="32" cy="30.5" r="22.5" fill="none" stroke="#ffd29b" strokeOpacity="0.48" />
      <text
        x="32"
        y="34.2"
        textAnchor="middle"
