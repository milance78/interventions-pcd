...
<Style ss:ID="Header"><Font ss:Bold="1"/><Interior ss:Color="#e5e7eb" ss:Pattern="Solid"/><Alignment ss:Horizontal="Center" ss:Vertical="Center" ss:WrapText="1"/></Style>
<Style ss:ID="Client"><Font ss:Bold="1" ss:Size="10"/></Style>
<Style ss:ID="Status_completed"><Interior ss:Color="#c7f4d5" ss:Pattern="Solid"/><Font ss:Bold="1"/></Style>
<Style ss:ID="Status_on_hold"><Interior ss:Color="#fde7a8" ss:Pattern="Solid"/><Font ss:Bold="1"/></Style>
<Style ss:ID="Status_transferred"><Interior ss:Color="#cbdfff" ss:Pattern="Solid"/><Font ss:Bold="1"/></Style>
<Style ss:ID="Status_consult_M_P"><Interior ss:Color="#e3d8fc" ss:Pattern="Solid"/><Font ss:Bold="1"/></Style>
<Style ss:ID="Status_closed_by_another_agent"><Interior ss:Color="#e5e7eb" ss:Pattern="Solid"/><Font ss:Bold="1"/></Style>
<Style ss:ID="Status_postponed"><Interior ss:Color="#eadcff" ss:Pattern="Solid"/><Font ss:Bold="1"/></Style>
<Style ss:ID="Status_empty"><Interior ss:Color="#f1f5f9" ss:Pattern="Solid"/></Style>
</Styles>
